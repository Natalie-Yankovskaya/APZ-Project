...
Breakdown.create(washer_id: 1, urgency: 'терміново', taken: false, status: false, comment:'Поломка')
Breakdown.create(washer_id: 2, urgency: 'не термінова', taken: false, status: false, comment:'Поломка')
